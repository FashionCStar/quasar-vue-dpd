        ...
        >
          <template v-slot:top>
            <div class="col-6 row justify-start">
              <q-input dense debounce="300" v-model="filter" placeholder="Search" input-class="text-white" style="width: 120px">
            ...
            <div class="col-6 row justify-end">
              <q-input dense v-model="fromDate" style="width:120px;" input-class="text-white">
                <template v-slot:append>
              ...
              <q-input dense v-model="endDate" style="width:120px;" input-class="text-white" class="q-ml-xs">
                <template v-slot:append>
                  <q-icon name="event" class="cursor-pointer" color="white">
                    <q-popup-proxy ref="qDateProxy" transition-show="scale" transition-hide="scale">
                      <q-calendar
            ...
            >
              <div class="row justify-between q-col-gutter-md" >
                <div class="col-12">
                  ...
                  <q-input dense outlined v-model="selectedRecord.report_date" bg-color="white" input-class="text-black text-center">
                    <template v-slot:append>
  ...
  data () {
    return {
      ...
      columns: [
        ...
        { name: 'is_group', required: true, label: 'Type', align: 'center', field: 'is_group' },
